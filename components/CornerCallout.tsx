export default function CornerCallout() {
  return (
    <aside className="static mt-6 w-full px-4 md:fixed md:bottom-6 md:right-6 md:mt-0 md:w-64">
      <div className="pixel-border rounded-lg bg-space-800/80 p-4 text-xs text-white/80 shadow-glow md:backdrop-blur">
