  ...
  return (
    <nav className="flex flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between md:px-10 md:py-5">
      ...
      <div className="flex flex-wrap items-center gap-3 md:flex-nowrap">
        <a
          href="/cart"
          className="rounded-md border border-dew-mint/50 px-3 py-2 text-[11px] font-arcade text-dew-mint transition hover:border-dew-mint hover:text-white md:text-xs"
        >
          Cart
        </a>
        <a
